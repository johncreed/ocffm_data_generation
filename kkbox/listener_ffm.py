...
# Field 1, 2
field1 = ['msno', 'city', 'gender']
field2 = ['source_system_tab', 'source_screen_name', 'source_type']
field3 = ['his']
all_fields = [field1, field2, field3]
...
of = open('listener.ffm', 'w')
rf = open('listener.csv')
